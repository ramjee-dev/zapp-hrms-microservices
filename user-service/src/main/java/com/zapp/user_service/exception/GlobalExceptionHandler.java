...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleUserNotFound(ResourceNotFoundException ex, WebRequest request) {
        log.warn("User not found: {}", ex.getMessage());
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, ex.getMessage());
        problemDetail.setTitle("User Not Found");
        problemDetail.setType(URI.create(BASE_PROBLEM_URI + "user-not-found"));
    ...
    public ResponseEntity<ProblemDetail> handleCandidateBusinessValidation(BusinessValidationException ex, WebRequest request) {
        log.warn("User business validation failed: {}", ex.getErrors());
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, ex.getMessage());
        problemDetail.setTitle("User Validation Failed");
        problemDetail.setType(URI.create(BASE_PROBLEM_URI + "user-validation-failed"));
        enrichMetadata(problemDetail, request);
