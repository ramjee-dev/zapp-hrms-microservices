package com.zapp.candidate_service.Constants;

public interface CandidatesConstants {

    String STATUS_200 = "200";
    String STATUS_201 = "201";
    String MESSAGE_201 = "Candidate Added To Job Successfully";
    String MESSAGE_200 = "Request Processed Successfully";
    String STATUS_500 = "500";
    String MESSAGE_500 = "An error occured please try again or contact dev team";
